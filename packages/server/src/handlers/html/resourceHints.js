...
export const resourceBlacklist = [
...
export const preloadChunks = ['main', 'vendor'];

// Filter out any sourceMap files, or anything in our resource blacklist
export const defaultExtract = chunkNames =>
  chunkNames
...
export const print = resourceHints =>
...
export const getResourceHints = manifest => [
